    ...
    <div className="terminal-window">
      ...
      <div className="terminal-content">
        ...
        <section style={{ marginTop: "2rem" }}>
          <p>
            <span className="prompt">$</span>cat skills.json
          </p>
        ...
        <section style={{ marginTop: "2rem" }}>
          ...
          >
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              <p>
                <strong>Senior Software Engineer</strong> @ TechCorp
              </p>
              <p style={{ fontSize: "0.9rem", opacity: 0.8 }}>
                Leading frontend development for a cloud-native platform.
              </p>
            </div>
            <div>
              <p style={{ color: "var(--accent)" }}>2021 - 2023</p>
              <p>
                <strong>Full Stack Developer</strong> @ StartupX
              </p>
              <p style={{ fontSize: "0.9rem", opacity: 0.8 }}>
                Built and scaled a real-time messaging application.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginTop: "2rem" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0 }}>
            <li>
              GitHub:{" "}
              <a
                href="https://github.com/TatsuyaM2667"
                target="_blank"
                rel="noreferrer"
              >
                TatsuyaM2667
            ...
            <li>
              Linkedin:{" "}
              <a
                href="https://www.linkedin.com/in/tatsuya-miura-1bb48339a/"
                target="_blank"
                rel="noreferrer"
              >
                @tatsuya
            ...
            <li>
              Email:{" "}
              <a href="mailto:hello@tatsuya.dev">tatsuyamiura2667@gmail.com</a>
            </li>
          </ul>
        </section>
