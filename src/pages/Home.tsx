    ...
    <div className="page-home" key={language}>
      ...
      <section style={{ marginTop: '2rem' }}>
        ...
        <div style={{ marginTop: '1rem' }}>
          <p><strong>OS</strong>: <Typewriter text="PortfolioOS v2.0.0" delay={5200} speed={20} /></p>
          <p><strong>Host</strong>: <Typewriter text={`${t.name}-Workstation`} delay={5500} speed={20} /></p>
          <p><strong>Kernel</strong>: <Typewriter text="React 19.2.6" delay={5800} speed={20} /></p>
          <p><strong>Shell</strong>: <Typewriter text="zsh 5.8" delay={6100} speed={20} /></p>
        </div>
      </section>
    </div>
  );
